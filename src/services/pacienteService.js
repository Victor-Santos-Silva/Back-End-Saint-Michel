...
const PacientesService = {
  ...
  create: async (cadastro) => {
    ...
    if (nomeCompleto.length < 3) {
      ...
      throw new Error("O nome completo deve conter no máximo 255 caracteres.");
      ...
      throw new Error("O nome completo não deve conter caracteres especiais.");
    ...
    if (!convenio_medico) {
      ...
      throw new Error("O convênio médico deve conter pelo menos 3 caracteres.");
    } else if (convenio_medico.length > 50) {
      throw new Error("O convênio médico deve conter no máximo 50 caracteres.");
    }
